...
# just add a few restaurants so there's something to see
r1 = Restaurant(name="Casa Frascati", zipcode="21235")
r2 = Restaurant(name="Don Fratello", zipcode="76537")
r3 = Restaurant(name="Zum goldenen Hirschen", zipcode="8888")
r4 = Restaurant(name="Lido", zipcode="90210")
session.add(r1)
session.add(r2)
session.add(r3)
session.add(r4)
